...
%
% Replaced \relsize{-3} with \smaller[0] and added \protect to be able to use \Cpp in e.g. \section or \chapter:
%\newcommand\Cpp{C\protect\nolinebreak\hspace{-.05em}\raisebox{.4ex}{\smaller[0]{\textbf{+}}}\protect\nolinebreak\hspace{-.10em}\raisebox{.4ex}{\smaller[0]{\textbf{+}}}}
\newcommand\Cpp{C\protect\nolinebreak[4]\hspace{-.05em}\raisebox{.4ex}{\smaller[0]{\textbf{++}}}}
%
