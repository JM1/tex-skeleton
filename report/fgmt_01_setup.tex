...
% TODO: Should we split *.dict files into separate files for translations and hyphenations?

\usepackage{etex} % increases the number of registers and thus prevents latex errors like '! No room for a new \<thing>...'

\usepackage[T1]{fontenc} % enables e.g. western european characters
\usepackage[utf8]{inputenc} % accept UTF8 input encodings, e.g. german umlaute.

\usepackage[
    english, % secondary language
    ngerman  % primary language
]{babel} % hyphenation
% NOTE: Do not use \hyphenation, instead add your hyphenations with \babelhyphenation to *.dict files!
...
\usepackage{textcomp} % Text Companion fonts, which provide many text symbols in the TS1 encoding,
                      % e.g. "registered"/"copyright"/"degree" symbols and \textquotesingle
...
\usepackage{helvet} % Helvetica, a sans serif font family
...
% Page headers and footers for KOMA-Script
% Customize using e.g. \KOMAoptions{headsepline}
% NOTE: scrpage2 is obsolete now!
...
\usepackage{relsize} % Set font size relative to current font size, e.g. \relsize

\usepackage{pdftexcmds} % e.g. \pdf@strcmp

\usepackage{layout} % \layout to display page layout variables
\usepackage{lastpage} % label LastPage (\AtEndDocument) allows to refer to the last page via \pageref{LastPage}
\usepackage{tabularx} % environment tabularx takes the same arguments as tabular*, but modifies the widths of certain
                      % columns, rather than the inter column space, to set a table with the requested total width.

% KOMA-Script improvements
% NOTE: scrhack is loaded at the end due to problems with e.g. package minted
\usepackage{scrhack}
...
% set of colors for diagrams
\definecolor{diag_blue}{HTML}{4d6da6}
\definecolor{diag_green}{HTML}{49a93f}
\definecolor{diag_red}{HTML}{9e2c2f}
\definecolor{diag_purple}{HTML}{673170}
\definecolor{diag_orange}{HTML}{ec9435}
...
% highlighting of product and brand names
\newcommand{\name}[1]{\textsf{#1}}
...
% Different Symbols for Programming Language C++
%
% \Cpp from C++ FAQ
% Ref.: https://tex.stackexchange.com/questions/4302/prettiest-way-to-typeset-c-cplusplus
%\newcommand\Cpp{C\nolinebreak\hspace{-.05em}\raisebox{.4ex}{\relsize{-3}{\textbf{+}}}\nolinebreak\hspace{-.10em}\raisebox{.4ex}{\relsize{-3}{\textbf{+}}}}
%\newcommand\Cpp{C\nolinebreak[4]\hspace{-.05em}\raisebox{.4ex}{\relsize{-3}{\textbf{++}}}}
%
% Replaced \relsize{-3} with \smaller[3] and added \protect to be able to use \Cpp in e.g. \section or \chapter:
%\newcommand\Cpp{C\protect\nolinebreak\hspace{-.05em}\raisebox{.4ex}{\smaller[3]{\textbf{+}}}\protect\nolinebreak\hspace{-.10em}\raisebox{.4ex}{\smaller[3]{\textbf{+}}}}
%\newcommand\Cpp{C\protect\nolinebreak[4]\hspace{-.05em}\raisebox{.4ex}{\smaller[3]{\textbf{++}}}}
%
%\newcommand{\Rplus}{\protect\hspace{-.1em}\protect\raisebox{.35ex}{\smaller{\smaller\textbf{+}}}}
%\newcommand{\Cpp}{\mbox{C\Rplus\Rplus}\xspace}
%
% \Cpp from Andreas Priesnitz
%\newcommand{\Cpp}{\name{C\kern-0.05em+\kern-0.03em+}\xspace}
%
% \Cpp from Andreas Priesnitz
%\newcommand{\pp}{\kern-0.05em\texttt{+\kern-0.03em+}\xspace}
%\newcommand{\Cpp}{\name{C}\pp}
...
\newcommand{\Cpp}{
    \ifnum\pdf@strcmp{\f@family}{\sfdefault}=\z@
        % Use \Cpp from Andreas Priesnitz for sans sarif font family
        \name{C}\pp
    \else
        % Use \Cpp from C++ FAQ for other font families
        C\protect\nolinebreak[4]\hspace{-.05em}\raisebox{.4ex}{\smaller[3]{\textbf{++}}}
    \fi
}
\makeatother
