...
%\usepackage{ulem} % fuer das Unterstreichen (ACHTUNG: Unterstrichene Wörter werden nicht umgebrochen. Dies führt z.B. im Literaturverzeichnis zu Problemen bei langen Titeln etc.!)
...
\usepackage[ngerman=ngerman-x-latest]{hyphsubst} %fuer korrekte Silbentrennung
...
\newunicodechar{𝛽}{\beta}
\newunicodechar{β}{\beta}
\newunicodechar{ϵ}{\epsilon}
\newunicodechar{σ}{\sigma}
\newunicodechar{τ}{\tau}
\newunicodechar{θ}{\theta}
\newunicodechar{𝛴}{\Sigma}
\newunicodechar{μ}{\mu}
\newunicodechar{→}{\rightarrow}
\newunicodechar{↓}{\downarrow}
\newunicodechar{×}{\times}
\newunicodechar{≡}{\equiv}
\newunicodechar{√}{\surd}%\textsurd
\newunicodechar{Σ}{\Sigma}
\newunicodechar{⇽}{\leftarrowtriangle}
\newunicodechar{⇾}{\rightarrowtriangle}
\newunicodechar{♯}{\sharp} % correct would be \musSharp{} from \usepackage{musicography} which is not in Debian Stretch or earlier.
\newunicodechar{ℝ}{\mathbb{R}}
\newunicodechar{ℂ}{\mathbb{C}}
\newunicodechar{ℤ}{\mathbb{Z}}
\newunicodechar{ℚ}{\mathbb{ℚ}}
...
% Ref.: 
%  http://projekte.dante.de/DanteFAQ/Silbentrennung#4
...
%Quelle: http://tex.stackexchange.com/questions/10743/why-does-latex-stretch-small-sections-across-the-whole-page-vertically/10747#10747
\raggedbottom


%Quelle: http://tex.stackexchange.com/a/44540
