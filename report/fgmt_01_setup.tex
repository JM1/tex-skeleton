...
%
% Without \nolinebreak and with \smaller[0] instead of \relsize{-3} to allow its usage in e.g. \section or \chapter:
\newcommand\Cpp{C\hspace{-.05em}\raisebox{.4ex}{\smaller[0]{\textbf{+}}}\hspace{-.10em}\raisebox{.4ex}{\smaller[0]{\textbf{+}}}}
%\newcommand\Cpp{C\hspace{-.05em}\raisebox{.4ex}{\smaller[0]{\textbf{++}}}}
%
